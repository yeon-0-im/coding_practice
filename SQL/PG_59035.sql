-- 문제 링크 (주석) : https://school.programmers.co.kr/learn/courses/30/lessons/59035
-- 간단한 문제 설명 : SQL을 실행하여 name과 datetime을 ANIMAL_ID의 역순으로 조회
-- 테이블 스키마 : 
--   - 테이블명 : AMIMAL_INS
--   - 컬럼명 및 타입 : 
                -- NAME	                TYPE	  NULLABLE
